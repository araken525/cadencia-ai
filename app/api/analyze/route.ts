...
5. [増六の和音] (厳格なスペル判定)
   - 条件: 低音と高音(または内声)の間に、**明確な「増6度」音程**が存在すること。(短7度とは区別せよ)
   - 判定: 増六の和音 (伊:It / 仏:Fr / 独:Ger を区別)
   - 解説: 「増六の和音。D機能としてVへ解決する」と言及。

6. [ナポリの六] (IIの根音半音下げ1転)
   - 条件: IIの根音を半音下げた長三和音の第1転回形。長調・短調問わず判定せよ。
   - 判定: N⁶ または II¹(根音変位)
   - 解説: 「ナポリの六。S機能として劇的な効果」と言及。

7. [ドリアのIV] (短調で#6を含むIV)
   - 条件: 短調において、音階の第6音を半音上げた音(旋律的短音階)を含むIVの和音(IV または IV₇)。
   - 【優先】: この場合、「Gへの副属七(V₇/VII)」という判定よりも「ドリアのIV」を優先せよ。
   - 判定: IV (または IV₇)
