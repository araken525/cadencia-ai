      ...
      <div className={`fixed bottom-0 inset-x-0 z-50 ${G.glassKey} rounded-t-[32px] pt-5 pb-8 shadow-[0_-10px_40px_rgba(0,0,0,0.03)] transition-transform duration-300 backdrop-blur-2xl`}>
        <div className="max-w-md mx-auto px-4">
          <div className="grid grid-cols-4 grid-rows-4 gap-2 h-full">
            ...
            <button className="col-start-4 row-start-1 h-14 rounded-2xl bg-white/40 border border-white/50 text-slate-400 active:text-rose-500 active:bg-rose-50 transition-all flex items-center justify-center shadow-sm active:scale-95 hover:bg-white/60" onClick={reset}><IconTrash /></button>
